...
public class PullRequestCommentConverterUnsupportedActionTest {
    ...
    @Mock
    private PullRequestComment mockPullRequestComment;
    ...
    public void givenAPullRequestCommentWithAnUnsupportedAction_whenConverting_thenThrowsException() throws ConverterException {
        given(mockPullRequestComment.getAction()).willReturn(unsupportedAction);

        converter.convertFrom(mockPullRequestComment);
    }
}
