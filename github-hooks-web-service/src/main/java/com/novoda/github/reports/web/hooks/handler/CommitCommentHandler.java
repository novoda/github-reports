...
class CommitCommentHandler implements EventHandler {
    ...
    public void handle(GithubWebhookEvent event) throws UnhandledEventException {
        CommitComment commitComment = extractCommitComment(event);
        persist(commitComment);
    }
    ...
    private void persist(CommitComment commitComment) throws UnhandledEventException {
        try {
